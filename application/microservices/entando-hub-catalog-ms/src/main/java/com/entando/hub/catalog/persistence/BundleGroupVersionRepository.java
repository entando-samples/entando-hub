...
public interface BundleGroupVersionRepository extends JpaRepository<BundleGroupVersion, Long>{
	...
	@Query(value = "select distinct bgv.* " +
			...
			nativeQuery = true)
	List<BundleGroupVersion> getPrivateCatalogPublishedTemplates(@Param("catalogId") Long catalogId);
	...
	@Query(value = "select distinct bgv.* " +
			...
			"  and bg.name= :name",
			nativeQuery = true)
	List<BundleGroupVersion> getPrivateCatalogPublishedTemplatesByName(@Param("catalogId") Long catalogId,
	...
	@Query(value = "select distinct bgv.* " +
			...
			"  and bg.name= :name",
			nativeQuery = true)
	List<BundleGroupVersion> getPublicCatalogPublishedTemplatesByName(@Param("name") String name);
